...
export default function Home() {
  ...
  return (
    <>
      <SideBar showSidebar={showSidebar} closeSidebar={handleSideBar} />
      <main className="before:absolute before:top-0 before:bottom-0 before:-left-32 before:right-[90%] before:border-t-2 before:border-r-2 before:border-l-0 before:border-b-2  before:bg-blue-500 flex min-h-screen flex-col items-center justify-center p-4 gap-4 overflow-auto relative">
